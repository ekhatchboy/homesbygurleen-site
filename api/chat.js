...
function buildPrompt(message, leadProfile, transcript) {
  ...
  return [
    ...
    "Keep the conversation efficient and premium, not chatty.",
    "Ask at most one follow-up question unless the user explicitly asks for a list.",
    "Prefer grouped collection in one message when information is still missing.",
    ...
    "Prioritize collecting: name, intent, location, timeline, price range, financing status, and contact information.",
    "If the user appears to be a buyer, focus on area, timing, budget, pre-approval status, and the best follow-up contact.",
    "If the user appears to be a seller, focus on property location, timing, motivation, valuation interest, and the best follow-up contact.",
    "If the user appears to be an investor, focus on area, budget, return goals, timeline, and the best follow-up contact.",
    ...
    "Keep replies under 55 words and sound personal rather than robotic.",
